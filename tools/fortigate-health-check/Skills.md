...
**Interpretation:**
"The FortiGate at 10.0.0.1 is healthy. CPU is at 42.5% (normal), memory at 60.2% (normal), with 1000 active sessions. The device is running FortiOS 7.4.1."
...
| `401 Unauthorized` | Bad API key | Verify credentials in config |
